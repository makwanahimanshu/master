                ...
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="<?php echo $base.'/assets/images/faces/face4.jpg';?>" alt="user" class="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="<?php echo $base.'/assets/images/faces/face2.jpg';?>" alt="user" class="user">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    <div class="item-thumbnail">
                      <img src="<?php echo $base.'/assets/images/faces/face3.jpg';?>" alt="user" class="user">
                    </div>
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
