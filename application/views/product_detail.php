        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo $base.'index.php/Product_details/pro_detail';?>">Product Detail</a></li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <div class="product-slider-single-nav normal-slider">
                                        <div class="slider-nav-img"><img src="<?php echo $base.'assets/img/product-1.jpg';?>" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="<?php echo $base.'assets/img/product-3.jpg';?>" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="<?php echo $base.'assets/img/product-5.jpg';?>" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="<?php echo $base.'assets/img/product-7.jpg';?>" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="<?php echo $base.'assets/img/product-9.jpg';?>" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="<?php echo $base.'assets/img/product-10.jpg';?>" alt="Product Image"></div>
                                    </div>
                                </div>
                                <div class="col-md-7">
